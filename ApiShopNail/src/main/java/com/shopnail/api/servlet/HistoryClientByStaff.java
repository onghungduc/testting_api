 ...
 */
@WebServlet("/historyClientByStaff")
public class HistoryClientByStaff extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			reponseRestult = ctrl.historyClientByStaff(con, jb.toString());
