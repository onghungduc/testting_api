...
/**
 * Servlet implementation class GetServiceTypeServlet
 */
@WebServlet("/getServiceType")
public class GetServiceTypeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			con = conDB.connect();
			ServiceTypeControler uc = new  ServiceTypeControler();
			reponseRestult = uc.getServiceType(con);
