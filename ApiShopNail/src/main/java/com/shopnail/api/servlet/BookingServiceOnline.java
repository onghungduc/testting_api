 ...
 */
@WebServlet("/bookingServiceOnline")
public class BookingServiceOnline extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			try {
				reponseRestult = ctrl.bookingServiceOnline(con, jb.toString());
