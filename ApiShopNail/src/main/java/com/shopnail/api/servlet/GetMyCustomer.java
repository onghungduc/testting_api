...
/**
 * Servlet implementation class getMyCustomer
 */
@WebServlet("/getMyCustomer")
public class GetMyCustomer extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			System.out.println("jb getMyCustomer === " + jb.toString());
			reponseRestult = ctrl.getMyCustomer(con, jb.toString());
